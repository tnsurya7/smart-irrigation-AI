...
class DailyWeatherEmailService {
    constructor() {
        this.apiKey = process.env.OPENWEATHER_API_KEY || "***REMOVED***";
        ...
        this.emailConfig = {
            ...
            auth: {
                ...
                pass: process.env.EMAIL_PASS || '***REMOVED***'  // Remove spaces from app password
            }
        };
    ...
    initialize() {
        try {
            ...
            console.log('📧 Recipients: ***REMOVED***, ***REMOVED***');
