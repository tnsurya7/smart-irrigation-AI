...
class DailyWeatherEmailService:
    def __init__(self):
        ...
        self.api_key = os.getenv("OPENWEATHER_API_KEY", "59ade005948b4c8f58a100afc603f047")
        self.city = "Erode,Tamil Nadu,IN"
        
        # Email configuration
        self.smtp_host = os.getenv("SMTP_HOST", "smtp.gmail.com")
        self.smtp_port = int(os.getenv("SMTP_PORT", "587"))
        self.email_user = os.getenv("EMAIL_USER", "suryakumar56394@gmail.com")
        self.email_pass = os.getenv("EMAIL_PASS", "iyaweppkgwibgqry")  # Remove spaces from app password
        self.recipients = os.getenv("EMAIL_RECIPIENTS", "suryakumar56394@gmail.com,monikam11g1@gmail.com").split(",")
